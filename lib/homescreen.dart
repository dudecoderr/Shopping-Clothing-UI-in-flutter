                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        child: Container(
                          width: width,
                          margin: EdgeInsets.only(right: rightMargin, left: iconHeight),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            "FREE",
                            style: TextStyle(color: Colors.black, fontSize: textHeight, fontWeight: FontWeight.bold),
                          ),
                          Text(
                            "METCON 3",
                            style: TextStyle(color: Colors.black, fontSize: textHeight, fontWeight: FontWeight.bold),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Icon(Icons.edit, color: Colors.black, size: iconHeight),
                    ],
                  ),
                ),
                SizedBox(
